...
def get_music_recommendation(emotion):
    emotion_music_mapping = {
        'Angry': [r"C:\Users\Janarthanan T\Desktop\project\song1.mp3"],
        'Disgust': [r"C:\Users\Janarthanan T\Desktop\project\song2.mp3"],
        'Fear': [r"C:\Users\Janarthanan T\Desktop\project\song3.mp3"],
        'Happy': [r"C:\Users\Janarthanan T\Desktop\project\Adada-Adada-MassTamilan.so.mp3"],
        'Sad': [r"C:\Users\Janarthanan T\Desktop\project\song5.mp3"],
        'Surprise': [r"C:\Users\Janarthanan T\Desktop\project\song6.mp3"],
        'Neutral': [r"C:\Users\Janarthanan T\Desktop\project\Andhiyiley-Vaanam-MassTamilan.com.mp3"]
    }
...
def recognize_emotion_from_camera():
    ...
    emotion_model = load_model(r"C:\Users\Janarthanan T\Desktop\project\emotion_model.hdf5", compile=False, custom_objects={'Adam': Adam()})
